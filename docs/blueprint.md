...
- 2026-06-13：**发布 v0.4.0**。0.3.0→0.4.0,Phase 11 成果(subgraph 分组含嵌套双向 / 暗色主题 / 模板系统 / elkjs 正交布局 / 方向键微移 + 双击建点进编辑)。108 测试绿,`drawmaker_0.4.0_aarch64.dmg` 构建+重装。tag v0.4.0 推 GitHub/forgejo,两端 Release 均挂 dmg(GitHub releases/tag/v0.4.0、forgejo release id 11)。
